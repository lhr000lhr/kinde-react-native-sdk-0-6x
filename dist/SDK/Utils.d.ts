...
export declare const isExpoGo = false;
...
export declare const openWebBrowser: (url: string, redirectUri: string, options?: AuthBrowserOptions) => Promise<import("react-native-inappbrowser-reborn").BrowserResult | import("react-native-inappbrowser-reborn").RedirectResult>;
